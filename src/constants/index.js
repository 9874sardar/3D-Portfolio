...
const experiences = [
  ...
  },
  {
    ...
    points: [
      ...
      "Collaborating with cross-functional teams including designers, backend developers",
      "Worked on implementing Push Notification, Location Services, Camera integration and many more.",
      "Intergation of AI tools like ChatGPT and DallE in the application.",
    ],
  },
];
